...
export class EditClientModalComponent {
    public clientForm = new FormGroup({
        firstName: new FormControl<string>(this.client.firstName, [
            Validators.required,
        ]),
        lastName: new FormControl<string>(this.client.lastName, [
            Validators.required,
        ]),
        document: new FormControl<string>(this.client.document, [
            Validators.required,
        ]),
        phone: new FormControl<string>(this.client.phone, [
            Validators.required,
        ]),
        address: new FormControl<string>(this.client.address, [
            Validators.required,
        ]),
    ...
    public async editClient() {
        await this.loaderService.doWithLoadingScreen(async () => {
            try {
                ...
                return Ok({
                    header: "Cliente editado",
                    body: "Se ha editado el cliente correctamente",
                });
            } catch (error: any) {
                return Err(error);
            }
